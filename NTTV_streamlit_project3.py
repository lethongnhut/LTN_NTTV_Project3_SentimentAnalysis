...
st.markdown("<h1 style='text-align: center; color: black;'>Sentiment Analysis on ShopeeFood </h1>", unsafe_allow_html=True)

menu = ['Tổng quan Project', 'Xây dựng mô hình', 'Dự đoán bình luận tiêu cực hay tích cực', 'Thông tin nhà hàng']
...
#----------------------------------------------------------------------------------------------------    
elif choice == 'Dự đoán bình luận tiêu cực hay tích cực':
#----------------------------------------------------------------------------------------------------
